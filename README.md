...
* `src/index.tx` is the TypeScript entry point.
...
* If the watcher doesn’t see a file called `index.ts/tsx` and you’re referencing it by the folder name, you [need to restart the watcher](https://github.com/facebookincubator/create-react-app/issues/1164) due to a Webpack bug.
